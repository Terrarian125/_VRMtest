...
- [x] VRMC_springBone_extended_collider extension
- [x] VRMC_vrm_animation extension
...
`VRM.h` is maintained directly; [vrm-specification](https://github.com/vrm-c/vrm-specification/tree/master/specification) remains the canonical reference for the JSON schemas.
